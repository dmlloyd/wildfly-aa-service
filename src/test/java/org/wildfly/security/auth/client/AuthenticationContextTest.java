...
public final class AuthenticationContextTest {
    ...
    private final AuthenticationConfiguration config1
            = AuthenticationConfiguration.empty().useName("name1").useAuthorizationName("1111").useSaslProtocol("protocol1").usePassword("password1");
    private final AuthenticationConfiguration config2
            = AuthenticationConfiguration.empty().useName("name2").useAuthorizationName("2222").useSaslProtocol("protocol2").usePassword("password2");
    private final AuthenticationConfiguration config3
            = AuthenticationConfiguration.empty().useName("name3").useAuthorizationName("3333").useSaslProtocol("protocol3").usePassword("password3");
    private final AuthenticationConfiguration config4
            = AuthenticationConfiguration.empty().useName("name4").useAuthorizationName("4444").useSaslProtocol("protocol4").usePassword("password4");
